    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        ActiveSub = c.Boolean(nullable: false),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Event_Id, t.Team_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Awards", "Game_Id", "dbo.Games");
            DropForeignKey("dbo.EventTeams", "Team_Id", "dbo.Teams");
            ...
            DropIndex("dbo.EventTeams", new[] { "Team_Id" });
            DropIndex("dbo.EventTeams", new[] { "Event_Id" });
            DropIndex("dbo.Awards", new[] { "Game_Id" });
